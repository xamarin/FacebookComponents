...
var ARTIFACTS = new List<ArtifactInfo> {
	new ArtifactInfo("facebook-android-sdk", "5.15.3"),
	new ArtifactInfo("facebook-core", "5.15.3"),
	new ArtifactInfo("facebook-common", "5.15.3"),
	new ArtifactInfo("facebook-login", "5.15.3"),
	new ArtifactInfo("facebook-share", "5.15.3"),
	new ArtifactInfo("facebook-places", "5.15.3"),
	new ArtifactInfo("facebook-applinks", "5.15.3"),
	new ArtifactInfo("facebook-messenger", "5.15.3"),
	new ArtifactInfo("facebook-livestreaming", "4.36.0"),
	new ArtifactInfo("facebook-loginkit", "4.36.0"),
	new ArtifactInfo("facebook-marketing", "5.15.3"),
	new ArtifactInfo("account-kit-sdk", "5.4.0"),
	new ArtifactInfo("audience-network-sdk", "5.9.0"),
