...
Artifact ACCOUNT_KIT_ARTIFACT = new Artifact ("AccountKit", "5.0.1", "8.0");
Artifact AUDIENCE_NETWORK_ARTIFACT = new Artifact ("FBAudienceNetwork", "5.3.2", "9.0", csprojName: "AudienceNetwork");
...
Artifact MARKETING_KIT_ARTIFACT = new Artifact ("FBSDKMarketingKit", "5.0.0", "8.0", csprojName: "MarketingKit", buildOrder: 2, includeDependencies: false);
