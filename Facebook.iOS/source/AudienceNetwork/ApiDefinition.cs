...
namespace Facebook.AudienceNetwork
{
	...
	interface AdChoicesView {
		...
		NativeHandle Constructor (NativeAdBase nativeAd);
		...
		NativeHandle Constructor (NativeAdBase nativeAd, bool expandable);
		...
		NativeHandle Constructor (NativeAdBase nativeAd, bool expandable, [NullAllowed] NativeAdViewAttributes attributes);
	...
	interface AdExperienceConfig : INSCopying
	{
		...
		NativeHandle Constructor (NSString adExperienceType);
	}
	...
	interface AdExtraHint {
		...
		NativeHandle Constructor (NSArray keywords);

		[Obsolete ("Keywords are no longer used in Audience Network.")]
		[Wrap ("this (NSArray.FromNSObjects<AdExtraHintKeyword> (k => k.GetConstant (), keywords))")]
		NativeHandle Constructor (AdExtraHintKeyword [] keywords);

		[Obsolete ("Keywords are no longer used in Audience Network.")]
		[Wrap ("this (NSArray.FromNSObjects (keywords))")]
		NativeHandle Constructor (NSString [] keywords);
	...
	interface AdView {
		...
		NativeHandle Constructor (string placementId, AdSize adSize, [NullAllowed] UIViewController rootViewController);
		...
		NativeHandle Constructor (string placementId, string bidPayload, [NullAllowed] UIViewController rootViewController, [NullAllowed] out NSError error);
	...
	interface AdInitSettings {
		...
		NativeHandle Constructor (string [] placementIds, string mediationService);
	...
	interface InterstitialAd {
		...
		[DesignatedInitializer]
		NativeHandle Constructor (string placementId);
	...
	interface NativeAdCollectionViewAdProvider {
		...
		NativeHandle Constructor (NativeAdsManager manager);
	...
	interface NativeAdCollectionViewCellProvider {
		...
		NativeHandle Constructor (NativeAdsManager manager, NativeAdViewType type);
		...
		NativeHandle Constructor (NativeAdsManager manager, NativeAdViewType type, NativeAdViewAttributes attributes);
	...
	interface NativeAdScrollView {
		...
		NativeHandle Constructor (NativeAdsManager manager, NativeAdViewType type, NativeAdViewAttributes attributes, nuint maximumNativeAdCount);
		...
		NativeHandle Constructor (NativeAdsManager manager, NativeAdScrollViewViewProviderHandler childViewProviderHandler);
		...
		NativeHandle Constructor (NativeAdsManager manager, NativeAdScrollViewViewProviderHandler childViewProviderHandler, nuint maximumNativeAdCount);
	}
	...
	interface NativeAdsManager
	{
		...
		NativeHandle Constructor (string placementId, nuint numAdsRequested);
	...
	interface RewardedVideoAd
	{
		...
		NativeHandle Constructor (string placementId, [NullAllowed] string userId, [NullAllowed] string currency);
