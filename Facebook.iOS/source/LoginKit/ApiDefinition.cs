...
namespace Facebook.LoginKit {
	...
	interface LoginManagerLoginResult {
		...
		NativeHandle Constructor ([NullAllowed] CoreKit.AccessToken token, [NullAllowed] CoreKit.AuthenticationToken authenticationToken, bool isCancelled, [NullAllowed] NSSet grantedPermissions, [NullAllowed] NSSet declinedPermissions);
	}
	...
	interface TooltipView {
		...
		NativeHandle Constructor ([NullAllowed] string tagline, [NullAllowed] string message, TooltipColorStyle colorStyle);
	...
	interface LoginConfiguration {
		...
		NativeHandle Constructor (string[] permissions, LoginTracking tracking, string nonce);

		[Export ("initWithPermissions:tracking:")]
		NativeHandle Constructor (string[] permissions, LoginTracking tracking);

		[Export ("initWithTracking:")]
		NativeHandle Constructor (LoginTracking tracking);
	}
	...
	interface ReferralManager {
		...
		NativeHandle Constructor ([NullAllowed] UIViewController viewController);
	...
	interface ReferralManagerResult {
		...
		[DesignatedInitializer]
		NativeHandle Constructor ([NullAllowed] ReferralCode [] referralCodes, bool isCancelled);
	}
}
